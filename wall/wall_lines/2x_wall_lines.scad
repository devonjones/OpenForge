...
module 2x_wall_line(sc, seed, manifold=0) {
...
module 2x_static_wall_line(front, back, side, manifold=0) {
...
module 2x_stagger_wall_line(sc, seed, manifold=0) {
...
module 2x_static_stagger_wall_line(front, back, side, manifold=0) {
  translate([0,1,0]) scale([1,1,1]) union() {
    translate([0.99,-0.01,-0.01]) cube([48.02,8.22,7.02]);
    translate([0,manifold,0]) union() {
...
module 2x_staggered_wall_top(seed) {
  seed_vect = rands(0, 100, 14, seed=seed);
  translate([0,1,0]) rotate([-90,0,0]) scale([1,1,8.2/7]) union() {
    translate([1,0,7]) rotate([0,90,0]) scale([7/10,1,5/7]) rand_face(seed_vect[6]);
    translate([6,0,0]) scale([.9,1,1]) rand_face(seed_vect[7]);
...
module 2x_static_staggered_wall_top(top) {
  translate([0,1,0]) rotate([-90,0,0]) scale([1,1,8.2/7]) union() {
