...
module 1x_wall_line(sc, seed, manifold=0) {
...
module 1x_static_wall_line(front, back, side, manifold=0) {
...
module 1x_stagger_wall_line(sc, seed, manifold=0) {
...
module 1x_static_stagger_wall_line(front, back, side, manifold=0) {
  translate([0,1,0]) scale([1,1,1]) union() {
    translate([1,0,0]) cube([23,8.2,7]);
    translate([0,manifold,0]) union() {
...
module 1x_staggered_wall_top(seed) {
...
module 1x_static_staggered_wall_top(top) {
  translate([0,1,0]) rotate([-90,0,0]) scale([1,1,8.2/7]) union() {
