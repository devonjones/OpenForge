...
module 2x_corner_line(sc, seed, manifold=0) {
  seed_vect = rands(0, 100, 20, seed=seed);
  
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,39.8,7]);
    translate([0,39.8,0]) cube([48,8.2,7]);
    ...
    translate([0,48-manifold,0]) union() {
      ...
      translate([19,0,0]) rotate([0,0,180]) scale([1,1,1]) rand_face(seed_vect[6]);
      translate([29,0,0]) rotate([0,0,180]) scale([1,1,1]) rand_face(seed_vect[7]);
      translate([39,0,0]) rotate([0,0,180]) scale([1,1,1]) rand_face(seed_vect[8]);
      translate([48,0,0]) rotate([0,0,180]) scale([0.9,1,1]) rand_face(seed_vect[9]);
    }
    translate([0,39.8-manifold,0]) union() {
      translate([9,0,0]) scale([1,1,1]) rand_face(seed_vect[10]);
      translate([19,0,0]) scale([1,1,1]) rand_face(seed_vect[11]);
      translate([29,0,0]) scale([1,1,1]) rand_face(seed_vect[12]);
      translate([39,0,0]) rotate([0,00,0]) scale([0.9,1,1]) rand_face(seed_vect[13]);
    }
    translate([8.2,manifold,0]) union() {
      translate([0,0,0]) rotate([0,0,90]) scale([0.9,1,1]) rand_face(seed_vect[14]);
      translate([0,9,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[15]);
      translate([0,19,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[16]);
      translate([0,29,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[17]);
    }
    translate([0,manifold,0]) rotate([0,0,0]) scale([.82,1,1]) rand_face(seed_vect[18]);
    translate([48-manifold,39.8,0]) rotate([0,0,90]) scale([.82,1,1]) rand_face(seed_vect[19]);
  }
}
      
module 2x_static_corner_line(back1, back2, interior1, interior2, side, manifold=0) {
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,39.8,7]);
    translate([0,39.8,0]) cube([48,8.2,7]);
    translate([0,manifold,0]) union() {
    ...
    translate([0,48-manifold,0]) union() {
      ...
      translate([48,0,0]) rotate([0,0,180]) scale([0.9,1,1]) static_face(back2[4]);
    }
    translate([0,39.8-manifold,0]) union() {
      ...
      translate([39,0,0]) rotate([0,00,0]) scale([0.9,1,1]) static_face(interior1[3]);
    }
    translate([8.2,manifold,0]) union() {
...
module 2x_stagger_corner_line(sc, seed, manifold=0) {
  ...
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    ...
    translate([0,manifold,0]) union() {
      ...
      translate([0,48,0]) rotate([0,0,270]) scale([1.4,1,1]) rand_face(seed_vect[4]);
    }
    translate([0,48-manifold,0]) union() {
      translate([14,0,0]) rotate([0,0,180]) scale([1.4,1,1]) rand_face(seed_vect[5]);
      translate([24,0,0]) rotate([0,0,180]) scale([1,1,1]) rand_face(seed_vect[6]);
      translate([34,0,0]) rotate([0,0,180]) scale([1,1,1]) rand_face(seed_vect[7]);
      translate([43,0,0]) rotate([0,0,180]) scale([0.9,1,1]) rand_face(seed_vect[8]);
      translate([48,0,7]) rotate([0,90,180]) scale([7/10,1,5/7]) rand_face(seed_vect[9]);
    }
    translate([0,39.8-manifold,0]) union() {
      translate([4,0,0]) scale([1,1,1]) rand_face(seed_vect[10]);
      translate([14,0,0]) scale([1,1,1]) rand_face(seed_vect[11]);
      translate([24,0,0]) scale([1,1,1]) rand_face(seed_vect[12]);
      translate([34,0,0]) scale([0.9,1,1]) rand_face(seed_vect[13]);
      translate([43,0,7]) rotate([0,90,0])scale([7/10,1,5/7]) rand_face(seed_vect[14]);
    }
    translate([8.2,manifold,0]) union() {
      translate([0,0,7]) rotate([0,90,90]) scale([7/10,1,5/7]) rand_face(seed_vect[15]);
      translate([0,5,0]) rotate([0,0,90]) scale([0.9,1,1]) rand_face(seed_vect[16]);
      translate([0,14,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[17]);
      translate([0,24,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[18]);
      translate([0,34,0]) rotate([0,0,90]) scale([1,1,1]) rand_face(seed_vect[19]);
    }
    translate([0,manifold,0]) rotate([0,0,0]) scale([.82,1,1]) rand_face(seed_vect[20]);
    translate([48-manifold,39.8,0]) rotate([0,0,90]) scale([.82,1,1]) rand_face(seed_vect[21]);
  }
}

module 2x_static_stagger_corner_line(back1, back2, interior1, interior2, side, manifold=0) {
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,39.8,7]);
    translate([0,39.8,0]) cube([48,8.2,7]);
    translate([0,manifold,0]) union() {
      ...
      translate([0,48,0]) rotate([0,0,270]) scale([1.4,1,1]) static_face(back1[4]);
    }
    translate([0,48-manifold,0]) union() {
      ...
      translate([48,0,7]) rotate([0,90,180]) scale([7/10,1,5/7]) static_face(back2[4]);
    }
    translate([0,39.8-manifold,0]) union() {
      ...
      translate([43,0,7]) rotate([0,90,0])scale([7/10,1,5/7]) static_face(interior1[4]);
    }
    translate([8.2,manifold,0]) union() {
...
module 2x_corner_top(seed) {
  ...
  translate([9.2,0,0]) scale([8.2/7,1,1]) union () {
    translate([0,-10,0]) rotate([-90,0,90]) scale([1,1,1]) rand_face(seed_vect[5]);
    translate([0,-20,0]) rotate([-90,0,90]) scale([1,1,1]) rand_face(seed_vect[6]);
    translate([0,-30,0]) rotate([-90,0,90]) scale([1,1,1]) rand_face(seed_vect[7]);
    translate([0,-38.8,0]) rotate([-90,0,90]) scale([0.9,1,1]) rand_face(seed_vect[8]);
  }
  translate([10,0,0]) rotate([-90,0,90]) scale([0.9,1,9/7]) rand_face(seed_vect[9]);
}

module 2x_static_corner_top(top) {
  translate([0,1,0]) rotate([-90,0,0]) scale([1,1,8.2/7]) union() {
    translate([10,0,0]) static_face(top[0]);
    translate([20,0,0]) static_face(top[1]);
    translate([30,0,0]) static_face(top[2]);
    translate([40,0,0]) scale([.9,1,1]) static_face(top[3]);
  }
  translate([9.2,0,0]) scale([8.2/7,1,1]) union () {
    translate([0,-10,0]) rotate([-90,0,90]) scale([1,1,1]) static_face(top[4]);
    translate([0,-20,0]) rotate([-90,0,90]) scale([1,1,1]) static_face(top[5]);
    translate([0,-30,0]) rotate([-90,0,90]) scale([1,1,1]) static_face(top[6]);
    translate([0,-38.8,0]) rotate([-90,0,90]) scale([0.9,1,1]) static_face(top[7]);
  }
