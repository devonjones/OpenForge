...
module 3x_corner_line(sc, seed, manifold=0) {
  seed_vect = rands(0, 100, 32, seed=seed);
  
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,64.8,7]);
...
module 3x_static_corner_line(back1, back2, interior1, interior2, side, manifold=0) {
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,64.8,7]);
    translate([0,64.8,0]) cube([73,8.2,7]);
    translate([0,manifold,0]) union() {
...
module 3x_stagger_corner_line(sc, seed, manifold=0) {
...
module 3x_static_stagger_corner_line(back1, back2, interior1, interior2, side, manifold=0) {
  translate([1,1,0]) scale([1,1,1+sc]) union() {
    translate([0,0,0]) cube([8.2,64.8,7]);
    translate([0,64.8,0]) cube([73,8.2,7]);
    translate([0,manifold,0]) union() {
...
module 3x_corner_top(seed) {
  ...
  translate([10,0,0]) rotate([-90,0,90]) scale([0.9,1,9/7]) rand_face(seed_vect[15]);
}

module 3x_static_corner_top(top) {
  translate([0,1,0]) rotate([-90,0,0]) scale([1,1,8.2/7]) union() {
  ...
  translate([10,0,0]) rotate([-90,0,90]) scale([0.9,1,9/7]) static_face(top[15]);
}
