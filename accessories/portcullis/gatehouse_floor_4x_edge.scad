...
module edge_wall_base(x,y) {
  union() {
    translate([0,0,0]) cube([25*x,10.21,7.5]);
    ...
    translate([0,25*y+10.19,0]) cube([25*x,10.21,7.5]);
    translate([1,25*y+11.2,7.5]) cube([25*x-2,8.2,3.7]);
    translate([1,25*y+3,7.5]) cube([8.2,8.2,3.7]);
    translate([25-9.2,25*y+3,7.5]) cube([8.2,8.2,3.7]);

    translate([1,25*y+3,11.2]) union() {
    ...
    translate([0,10.2,0]) import(str("../../stone/floor_tile/stone_floor_",x,"x",y,".stl"));
  }
}
